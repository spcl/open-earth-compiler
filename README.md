...
The repository depends on a build of LLVM including MLIR. The Open Earth Compiler build has been tested with LLVM commit ffd0b31c7cb using the following configuration:
```

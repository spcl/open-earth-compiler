...
The repository depends on a build of LLVM including MLIR. The Open Earth Compiler build has been tested with LLVM commit 7186a3965af2 using the following configuration:
```

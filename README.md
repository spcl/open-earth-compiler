...
The repository depends on a build of LLVM including MLIR. The Open Earth Compiler build has been tested with LLVM commit 713c2ad60c1 using the following configuration:
```

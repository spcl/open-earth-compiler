...
The repository depends on a build of LLVM including MLIR. The Open Earth Compiler build has been tested with LLVM commit 631501b1f90e using the following configuration:
```

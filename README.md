...
The repository depends on a build of LLVM including MLIR. The Open Earth Compiler build has been tested with LLVM commit e2dee9af8db using the following configuration:
```

...
func @parallel_loop(%arg0 : f64) attributes {stencil.program} {
  ...
  %0 = stencil.apply (%arg1 = %arg0 : f64) -> !stencil.temp<ijk,f64> {
...
func @alloc_temp(%arg0 : f64) attributes {stencil.program} {
  ...
  %1 = stencil.apply (%arg1 = %0 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    // CHECK: load [[TEMP]]  
...
func @return_lowering(%arg0: f64) attributes {stencil.program} {
  // CHECK: loop.parallel ([[ARG0:%.*]], [[ARG1:%.*]], [[ARG2:%.*]]) =
  %0:2 = stencil.apply (%arg1 = %arg0 : f64) -> (!stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>) {
...
func @store_lowering(%arg0: !stencil.field<ijk,f64>) attributes {stencil.program} {
  ...
  %0 = stencil.apply (%arg1 = %cst : f64) -> !stencil.temp<ijk,f64> {
    // CHECK: store %{{.*}} [[VIEW]]
    stencil.return %arg1 : f64
  } to ([0, 0, 0]:[7, 7, 7]) 
  stencil.store %0 to %arg0 ([1, 2, 3]:[8, 9, 10]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  return
}

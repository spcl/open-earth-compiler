...
//  CHECK-NEXT: %{{.*}} = stencil.load %{{.*}} : (!stencil.field<?x?x?xf64>) -> !stencil.view<16x16x16xf64>
//  CHECK-NEXT: %{{.*}} = stencil.apply @lap(%{{.*}}) {{.*}} : (!stencil.view<16x16x16xf64>) -> !stencil.view<14x14x16xf64>
//  CHECK-NEXT: %{{.*}} = stencil.apply @lap(%{{.*}}) {{.*}} : (!stencil.view<14x14x16xf64>) -> !stencil.view<12x12x16xf64>
//  CHECK-NEXT: stencil.store %{{.*}} to %{{.*}} : !stencil.view<12x12x16xf64>, !stencil.field<12x12x16xf64>

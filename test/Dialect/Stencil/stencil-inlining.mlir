...
//  CHECK-NEXT: %{{.*}} = stencil.apply ([[ARG0:%.*]] = %{{.*}} : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
...
func @simple(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>) attributes {stencil.program} {
  ...
  %2 = stencil.apply (%arg2 = %0 : !stencil.temp<ijk,f64>, %arg3 = %1 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    %3 = stencil.access %arg2 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %4 = stencil.access %arg3 [1, 2, 3] : (!stencil.temp<ijk,f64>) -> f64
    %5 = addf %3, %4 : f64
    stencil.return %5 : f64
  }
...
//  CHECK-NEXT: %{{.*}} = stencil.load %{{.*}} : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
//  CHECK-NEXT: %{{.*}} = stencil.load %{{.*}} : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
//  CHECK-NEXT: %{{.*}} = stencil.apply ([[ARG0:%.*]] = %{{.*}} : !stencil.temp<ijk,f64>, [[ARG1:%.*]] = %{{.*}} : !stencil.temp<ijk,f64>) ->
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG0]] [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG0]] [-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG0]] [1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG1]] [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
func @multiple_edges(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>, %arg2: !stencil.field<ijk,f64>) attributes {stencil.program} {
  stencil.assert %arg0([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg1([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg2([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  %0 = stencil.load %arg0 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %1:2 = stencil.apply (%arg3 = %0 : !stencil.temp<ijk,f64>) -> (!stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>) {
    %4 = stencil.access %arg3 [-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %5 = stencil.access %arg3 [1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    stencil.return %4, %5 : f64, f64
  }
  %2 = stencil.load %arg1 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %3 = stencil.apply (%arg3 = %0 : !stencil.temp<ijk,f64>, %arg4 = %1#0 : !stencil.temp<ijk,f64>, %arg5 = %1#1 : !stencil.temp<ijk,f64>, %arg6 = %2 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    %4 = stencil.access %arg3 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %5 = stencil.access %arg4 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %6 = stencil.access %arg5 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %7 = stencil.access %arg6 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %8 = addf %4, %5 : f64
    %9 = addf %6, %7 : f64
    %10 = addf %8, %9 : f64
    stencil.return %10 : f64
  }
  stencil.store %3 to %arg2([0, 0, 0] : [64, 64, 60]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  return
}
...
func @avoid_redundant(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>) attributes {stencil.program} {
  stencil.assert %arg0([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg1([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  %0 = stencil.load %arg0 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %1 = stencil.apply (%arg2 = %0 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
  ...
  %2 = stencil.apply (%arg2 = %1 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    %3 = stencil.access %arg2 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
...
func @reroute(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>, %arg2: !stencil.field<ijk,f64>) attributes {stencil.program} {
  stencil.assert %arg0([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg1([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg2([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  %0 = stencil.load %arg0 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %1 = stencil.apply (%arg3 = %0 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    %3 = stencil.access %arg3 [-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %4 = stencil.access %arg3 [1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %5 = addf %3, %4 : f64
    stencil.return %5 : f64
  }
  %2 = stencil.apply (%arg3 = %0 : !stencil.temp<ijk,f64>, %arg4 = %1 : !stencil.temp<ijk,f64>) -> !stencil.temp<ijk,f64> {
    %3 = stencil.access %arg3 [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
    %4 = stencil.access %arg4 [1, 2, 3] : (!stencil.temp<ijk,f64>) -> f64
    %5 = addf %3, %4 : f64
    stencil.return %5 : f64
  }
...
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG0]] [1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
//   CHECK-DAG: %{{.*}} = stencil.access [[ARG0]] [0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
func @root(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>, %arg2: !stencil.field<ijk,f64>) attributes {stencil.program} {
  stencil.assert %arg0([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg1([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %arg2([-3, -3, 0] : [67, 67, 60]) : !stencil.field<ijk,f64>
  %0 = stencil.load %arg0 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>

...
func @simple(%in : !stencil.field<ijk,f64>, %out : !stencil.field<ijk,f64>)
  ...
  %0 = stencil.load %in : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %1 = stencil.apply %arg1 = %0 : !stencil.temp<ijk,f64> {  
      %2 = stencil.access %arg1[-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %3 = stencil.access %arg1[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %4 = addf %2, %3 : f64
      stencil.return %4 : f64
	} : !stencil.temp<ijk,f64>
  %5 = stencil.apply %arg2 = %0, %arg3 = %1 : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64> {  
      %6 = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %7 = stencil.access %arg3[1, 2, 3] : (!stencil.temp<ijk,f64>) -> f64
      %8 = addf %6, %7 : f64
      stencil.return %8 : f64
	} : !stencil.temp<ijk,f64>
	stencil.store %5 to %out ([0, 0, 0]:[64, 64, 60]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  return
}
...
func @multiple_edges(%in1 : !stencil.field<ijk,f64>, %in2 : !stencil.field<ijk,f64>, %out : !stencil.field<ijk,f64>)
  ...
  stencil.assert %out ([-3, -3, 0]:[67, 67, 60]) : !stencil.field<ijk,f64>
  %0 = stencil.load %in1 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %1,%2 = stencil.apply %arg1 = %0 : !stencil.temp<ijk,f64> {  
      %3 = stencil.access %arg1[-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %4 = stencil.access %arg1[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      stencil.return %3, %4 : f64, f64
	} : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>
  %5 = stencil.load %in2 : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %6 = stencil.apply %arg2 = %0, %arg3 = %1, %arg4 = %2, %arg5 = %5 : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64> {  
      %7 = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %8 = stencil.access %arg3[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %9 = stencil.access %arg4[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
	...
	stencil.store %6 to %out ([0, 0, 0]:[64, 64, 60]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  return
}
...
func @avoid_redundant(%in : !stencil.field<ijk,f64>, %out : !stencil.field<ijk,f64>)
  ...
  %5 = stencil.apply %arg2 = %1 : !stencil.temp<ijk,f64> {  
      %6 = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %7 = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %8 = addf %6, %7 : f64
      stencil.return %8 : f64
...
func @reroute(%in : !stencil.field<ijk,f64>, %out1 : !stencil.field<ijk,f64>, %out2 : !stencil.field<ijk,f64>)
  ...
  stencil.store %1 to %out1 ([0, 0, 0]:[64, 64, 60]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  stencil.store %5 to %out2 ([0, 0, 0]:[64, 64, 60]) : !stencil.temp<ijk,f64> to !stencil.field<ijk,f64>
  return
}
...
func @root(%in : !stencil.field<ijk,f64>, %out1 : !stencil.field<ijk,f64>, %out2 : !stencil.field<ijk,f64>)
  ...
  %5 = stencil.apply %arg2 = %0 : !stencil.temp<ijk,f64> {  
        %6 = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64

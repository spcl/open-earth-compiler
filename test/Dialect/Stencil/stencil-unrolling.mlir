...
func @unroll_accesses(%arg0 : !stencil.field<ijk,f64>, %arg1 : !stencil.field<ijk,f64>) attributes { stencil.program } {
  ...
  %1 = stencil.apply %arg2 = %0 : !stencil.view<ijk,f64> {
      ...
      // CHECK: [[ACC3:%.*]] = stencil.access {{%.*}}[0, 2, 0] : (!stencil.view<ijk,f64>) -> f64
      // CHECK: [[ACC4:%.*]] = stencil.access {{%.*}}[0, 3, 0] : (!stencil.view<ijk,f64>) -> f64
      %2 = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      // CHECK: stencil.return unroll [1, 4, 1] [[ACC1]], [[ACC2]], [[ACC3]], [[ACC4]]  : f64
      stencil.return %2 : f64
	} to ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64>

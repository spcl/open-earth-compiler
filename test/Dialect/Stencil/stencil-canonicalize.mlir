...
// CHECK-LABEL: func @canonical(%{{.*}}: !stencil.field<ijk,f64>, %{{.*}}: !stencil.field<ijk,f64>, %{{.*}}: !stencil.field<ijk,f64>) attributes {stencil.program}
...
func @canonical(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>, %arg2: !stencil.field<ijk,f64>) attributes {stencil.program} {
  ...
  %1,%2 = stencil.apply (%arg3 = %0 : !stencil.temp<ijk,f64>, %arg4 = %0 : !stencil.temp<ijk,f64>) -> (!stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>) {

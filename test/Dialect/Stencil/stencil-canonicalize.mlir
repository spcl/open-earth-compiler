...
module {
  func @canonical(%arg0: !stencil.field<ijk,f64>, %arg1: !stencil.field<ijk,f64>, %arg2: !stencil.field<ijk,f64>) attributes {stencil.program} {
    ...
    %1,%2 = stencil.apply %arg3 = %0, %arg4 = %0 : !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      %3 = stencil.access %arg3[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %4 = stencil.access %arg4[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %5 = addf %3, %4 : f64
    ...
    stencil.store %2 to %arg2 ([0, 0, 0]:[64, 64, 60]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
    return
  }
}

//       CHECK: %{{.*}} = stencil.apply %{{.*}} = %{{.*}} : !stencil.view<ijk,f64> {

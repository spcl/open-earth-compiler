...
func @multiple_extra(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
  ...
  stencil.store %6#3 to %3([32, 0, 0] : [64, 64, 60]) : !stencil.temp<64x64x60xf64> to !stencil.field<70x70x60xf64>
  return
}
...
func @multiple_apply(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
  // CHECKINT-COUNT-1: {{%.*}} = stencil.apply
  // CHECK-COUNT-1: {{%.*}} = stencil.apply
  %0 = stencil.cast %arg0([-3, -3, 0] : [67, 67, 60]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<70x70x60xf64>
  %1 = stencil.cast %arg1([-3, -3, 0] : [67, 67, 60]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<70x70x60xf64>
  // CHECK-DAG: [[CST0:%.*]] = constant 0.000000e+00 : f64
  // CHECK-DAG: [[CST1:%.*]] = constant 1.000000e+00 : f64
  ...
  %4 = stencil.apply -> (!stencil.temp<32x64x60xf64>) {
    // CHECK-DAG: [[RES0:%.*]] = stencil.store_result [[CST0]] : (f64) -> !stencil.result<f64>
    %cst = constant 0.000000e+00 : f64
    %8 = stencil.store_result %cst : (f64) -> !stencil.result<f64>
    stencil.return %8 : !stencil.result<f64>
  } to ([0, 0, 0] : [32, 64, 60])
  %5 = stencil.apply -> (!stencil.temp<32x64x60xf64>) {
    // CHECK-DAG: [[RES1:%.*]] = stencil.store_result [[CST1]] : (f64) -> !stencil.result<f64>
  ...
  %7:2 = stencil.combine 0 at 32 lower = (%4, %5 : !stencil.temp<32x64x60xf64>, !stencil.temp<32x64x60xf64>) upper = (%6#0, %6#1 : !stencil.temp<32x64x60xf64>, !stencil.temp<32x64x60xf64>) ([0, 0, 0] : [64, 64, 60]) : !stencil.temp<64x64x60xf64>, !stencil.temp<64x64x60xf64>

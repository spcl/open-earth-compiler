...
// CHECK-LABEL: func @kjoverlap(%{{.*}}: !stencil.field<?x?x?xf64>, %{{.*}}: !stencil.field<?x?x?xf64>, %{{.*}}: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
func @kjoverlap(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
  %0 = stencil.cast %arg0([-3, -3, 0] : [67, 67, 60]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<70x70x60xf64>
  %1 = stencil.cast %arg1([-3, -3, 0] : [67, 67, 60]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<70x70x60xf64>
  %2 = stencil.cast %arg2([-3, -3, 0] : [67, 67, 60]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<70x70x60xf64>
  %3 = stencil.load %0 : (!stencil.field<70x70x60xf64>) -> !stencil.temp<?x?x?xf64>
  ...
  // CHECK:      [[TEMP3:%.*]]:2 = stencil.combine 1 at 0 lower = ([[TEMP1]] : !stencil.temp<?x?x?xf64>) upper = ([[TEMP1]] : !stencil.temp<?x?x?xf64>) upperext = ([[TEMP2]] : !stencil.temp<?x?x?xf64>) : !stencil.temp<?x?x?xf64>, !stencil.temp<?x?x?xf64>
  // CHECK-NEXT: [[TEMP4:%.*]]:2 = stencil.combine 2 at 59 lower = ([[TEMP3]]#0 : !stencil.temp<?x?x?xf64>) upper = ([[TEMP1]] : !stencil.temp<?x?x?xf64>) lowerext = ([[TEMP3]]#1 : !stencil.temp<?x?x?xf64>) : !stencil.temp<?x?x?xf64>, !stencil.temp<?x?x?xf64>
  // CHECK-NEXT: stencil.store [[TEMP4:%.*]]#0 to %{{.*}}([0, -1, 0] : [64, 64, 60]) : !stencil.temp<?x?x?xf64> to !stencil.field<70x70x60xf64>
  // CHECK-NEXT: stencil.store [[TEMP4:%.*]]#1 to %{{.*}}([0, 0, 0] : [64, 64, 59]) : !stencil.temp<?x?x?xf64> to !stencil.field<70x70x60xf64>
  stencil.store %4 to %1([0, -1, 0] : [64, 64, 60]) : !stencil.temp<?x?x?xf64> to !stencil.field<70x70x60xf64>
  stencil.store %5 to %2([0, 0, 0] : [64, 64, 59]) : !stencil.temp<?x?x?xf64> to !stencil.field<70x70x60xf64>
  return
}
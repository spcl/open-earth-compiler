...
func @hdiffsa(%uin_fd : !stencil.field<ijk,f64>, %mask_fd : !stencil.field<ijk,f64>, %uout_fd : !stencil.field<ijk,f64>, %crlato_fd : !stencil.field<j,f64>, %crlatu_fd : !stencil.field<j,f64>)
  ...
  // lap
  %lap = stencil.apply %arg1 = %uin, %arg2 = %crlato, %arg3 = %crlatu: !stencil.temp<ijk,f64>, !stencil.temp<j,f64>, !stencil.temp<j,f64> {
  ...
  // flx
  %flx = stencil.apply %arg4 = %uin, %arg5 = %lap : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64> {
      %0 = stencil.access %arg5[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %1 = stencil.access %arg5[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %2 = subf %0, %1 : f64
      %3 = stencil.access %arg4[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
  ...
  // fly
  %fly = stencil.apply %arg6 = %uin, %arg7 = %lap, %arg8 = %crlato : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<j,f64> {
      %0 = stencil.access %arg7[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      %1 = stencil.access %arg7[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %2 = subf %0, %1 : f64
      %3 = stencil.access %arg8[0, 0, 0] : (!stencil.temp<j,f64>) -> f64
      %4 = mulf %2, %3 : f64
      %5 = stencil.access %arg6[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      %6 = stencil.access %arg6[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %7 = subf %5, %6 : f64
      %8 = mulf %4, %7 : f64
      %c0 = constant 0.0 : f64
      %9 = cmpf "ogt", %8, %c0 : f64
  ...
  // out
  %out = stencil.apply %arg9 = %uin, %arg10 = %flx, %arg11 = %fly, %arg12 = %mask : !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64> {
      %0 = stencil.access %arg10[-1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %1 = stencil.access %arg10[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %2 = subf %0, %1 : f64
      %3 = stencil.access %arg11[0, -1, 0] : (!stencil.temp<ijk,f64>) -> f64
      %4 = stencil.access %arg11[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %5 = subf %3, %4 : f64
      %6 = addf %2, %5 : f64
      %7 = stencil.access %arg12[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %8 = mulf %7, %6 : f64

//  bin/oec-opt --stencil-shape-inference --stencil-shape-shift --convert-stencil-to-standard ../test/Examples/lap.mlir

func @hdiff(%uin_fd : !stencil.field<ijk,f64>, %lap_fd : !stencil.field<ijk,f64>)
  attributes { stencil.program } {
	stencil.assert %uin_fd ([-3, -3, 0]:[67, 67, 60]) : !stencil.field<ijk,f64>
  stencil.assert %lap_fd ([-3, -3, 0]:[67, 67, 60]) : !stencil.field<ijk,f64>

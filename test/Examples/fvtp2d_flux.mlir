func @fvtp2d_flux(
  ...
  %q_j  = stencil.load %q_j_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %fx1i = stencil.load %fx1i_fd : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %fx2  = stencil.load %fx2_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %fy2  = stencil.load %fy2_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>

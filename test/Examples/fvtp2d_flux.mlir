...
module {
  func @fvtp2d_flux(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>, %arg4: !stencil.field<?x?x?xf64>, %arg5: !stencil.field<?x?x?xf64>, %arg6: !stencil.field<?x?x?xf64>, %arg7: !stencil.field<?x?x?xf64>, %arg8: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
    ...
    %17:4 = stencil.apply (%arg9 = %12 : !stencil.temp<?x?x?xf64>, %arg10 = %16 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>, !stencil.temp<?x?x?xf64>, !stencil.temp<?x?x?xf64>, !stencil.temp<?x?x?xf64>) {
      ...
      stencil.return %23, %25, %26, %29 : f64, f64, f64, f64
    }
    %18 = stencil.apply (%arg9 = %12 : !stencil.temp<?x?x?xf64>, %arg10 = %9 : !stencil.temp<?x?x?xf64>, %arg11 = %17#0 : !stencil.temp<?x?x?xf64>, %arg12 = %17#1 : !stencil.temp<?x?x?xf64>, %arg13 = %17#2 : !stencil.temp<?x?x?xf64>, %arg14 = %17#3 : !stencil.temp<?x?x?xf64>) -> !stencil.temp<?x?x?xf64> {
      ...
      %29 = scf.if %28 -> (f64) {
        %32 = stencil.access %arg12 [0, -1, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %33 = stencil.access %arg13 [0, -1, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %34 = mulf %27, %33 : f64
        %35 = subf %32, %34 : f64
        %36 = subf %cst_0, %27 : f64
        %37 = mulf %36, %35 : f64
        scf.yield %37 : f64
      } else {
        %32 = stencil.access %arg11 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %33 = stencil.access %arg13 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %34 = mulf %27, %33 : f64
        %35 = addf %32, %34 : f64
        %36 = addf %cst_0, %27 : f64
        %37 = mulf %36, %35 : f64
        scf.yield %37 : f64
      }
      %30 = mulf %29, %26 : f64
      %31 = scf.if %28 -> (f64) {
        %32 = stencil.access %arg9 [0, -1, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %33 = addf %32, %30 : f64
        scf.yield %33 : f64
      } else {
        %32 = stencil.access %arg9 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
        %33 = addf %32, %30 : f64
        scf.yield %33 : f64
      }
      stencil.return %31 : f64

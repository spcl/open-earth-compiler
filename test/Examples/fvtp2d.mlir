func @fvtp2d(
  ...
  %crx  = stencil.load %crx_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %cry  = stencil.load %cry_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %ra_x = stencil.load %ra_x_fd : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %ra_y = stencil.load %ra_y_fd : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %xfx  = stencil.load %xfx_fd  : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  ...
  // fx1
  %al_fx1 = stencil.apply %arg1 = %q_i : !stencil.view<ijk,f64> {
      %one = constant 1.0 : f64
      %seven = constant 7.0 : f64
      %twelve = constant 12.0 : f64
      %p1 = divf %seven, %twelve : f64
      ...
      %q_i_im1 = stencil.access %arg1[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_i_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64

      %q_i_im1pcen = addf %q_i_im1, %q_i_cen : f64

      %q_i_im2 = stencil.access %arg1[-2, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_i_ip1 = stencil.access %arg1[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  %almq_fx1, %br_fx1, %b0_fx1, %smt5_fx1 = stencil.apply %arg1 = %q_i, %arg2 = %al_fx1 : !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      %zero = constant 0.0 : f64
      %one = constant 1.0 : f64
      ...
      %al_ip1 = stencil.access %arg2[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      ...
      %smt5_im1 = stencil.access %arg6[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      ...
      %crx_cen = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %crxgzero = cmpf "ogt", %crx_cen, %zero : f64

      %crxtmp = loop.if %crxgzero -> (f64) {
          %br_im1 = stencil.access %arg4[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
          %b0_im1 = stencil.access %arg5[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  // fx2
  %al_fx2 = stencil.apply %arg1 = %q : !stencil.view<ijk,f64> {
      %one = constant 1.0 : f64
      %seven = constant 7.0 : f64
      %twelve = constant 12.0 : f64
      %p1 = divf %seven, %twelve : f64
      ...
      %q_im1 = stencil.access %arg1[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64

      %q_im1pcen = addf %q_im1, %q_cen : f64

      %q_im2 = stencil.access %arg1[-2, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_ip1 = stencil.access %arg1[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  %almq_fx2, %br_fx2, %b0_fx2, %smt5_fx2 = stencil.apply %arg1 = %q, %arg2 = %al_fx2 : !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      %zero = constant 0.0 : f64
      %one = constant 1.0 : f64
  ...
  // q_j
  %fxx = stencil.apply %arg1 = %xfx, %arg2 = %fx2 : !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      %xfx_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %fx2_cen = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      ...
      %fxx_cen = stencil.access %arg3[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %fxx_ip1 = stencil.access %arg3[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  // fy1
  %al_fy1 = stencil.apply %arg1 = %q_j : !stencil.view<ijk,f64> {
      %one = constant 1.0 : f64
      %seven = constant 7.0 : f64
      %twelve = constant 12.0 : f64
      %p1 = divf %seven, %twelve : f64
      ...
      %q_j_jm1 = stencil.access %arg1[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_j_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64

      %q_j_jm1pcen = addf %q_j_jm1, %q_j_cen : f64

      %q_j_jm2 = stencil.access %arg1[0, -2, 0] : (!stencil.view<ijk,f64>) -> f64
      %q_j_jp1 = stencil.access %arg1[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  %almq_fy1, %br_fy1, %b0_fy1, %smt5_fy1 = stencil.apply %arg1 = %q_j, %arg2 = %al_fy1 : !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      %zero = constant 0.0 : f64
      %one = constant 1.0 : f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      ...
      %fx1_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %fx2_cen = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      ...
      %xfx_cen = stencil.access %arg3[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {
      ...
      %fy1_cen = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %fy2_cen = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      ...
      %yfx_cen = stencil.access %arg3[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  stencil.store %q_j to %q_j_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
  stencil.store %fx1 to %fx1_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
  stencil.store %fx2 to %fx2_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
  stencil.store %fy1 to %fy1_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>

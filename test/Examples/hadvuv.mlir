...
module {
  func @hadvuv(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>, %arg4: !stencil.field<0x?x0xf64>, %arg5: !stencil.field<0x?x0xf64>, %arg6: !stencil.field<0x?x0xf64>, %arg7: !stencil.field<0x?x0xf64>) attributes {stencil.program} {
    ...
    %8 = stencil.apply (%arg10 = %0 : !stencil.temp<?x?x?xf64>, %arg11 = %6#1 : !stencil.temp<?x?x?xf64>, %arg12 = %7#1 : !stencil.temp<?x?x?xf64>) -> !stencil.temp<?x?x?xf64> {
      ...
      %131 = stencil.access %arg10 [-2, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      %132 = addf %21, %18 : f64
      %133 = mulf %15, %19 : f64
      %134 = mulf %14, %131 : f64
      %135 = addf %133, %134 : f64
      %136 = addf %132, %135 : f64
      %137 = mulf %136, %16 : f64

      %231 = stencil.access %arg10 [2, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      %232 = mulf %15, %18 : f64
      %233 = addf %21, %19 : f64
      %234 = mulf %14, %231 : f64
      %235 = addf %232, %234 : f64
      %236 = addf %233, %235 : f64
      %237 = negf %16 : f64
      %238 = mulf %237, %236 : f64

      %22 = select %20, %137, %238 : f64
      ...
      %331 = stencil.access %arg10 [0, -2, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      %332 = addf %21, %24 : f64
      %333 = mulf %15, %25 : f64
      %334 = mulf %14, %331 : f64
      %335 = addf %333, %334 : f64
      %336 = addf %332, %335 : f64
      %337 = mulf %336, %23 : f64

      %431 = stencil.access %arg10 [0, 2, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      %432 = mulf %15, %24 : f64
      %433 = addf %21, %25 : f64
      %434 = mulf %14, %431 : f64
      %435 = addf %432, %434 : f64
      %436 = addf %433, %435 : f64
      %437 = negf %23 : f64
      %438 = mulf %437, %436 : f64

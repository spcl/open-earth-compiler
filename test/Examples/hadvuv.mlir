...
func @hadvuv(
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, f64, f64 {
      ...
      %three = constant 3.0 : f64
      %six = constant 6.0 : f64
      %-1by6 = divf %minus_one, %six  : f64
      %-1by2 = constant -0.5 : f64
      %-1by3 = divf %minus_one, %three : f64
      ...
      %idir_res = loop.if %uavg_g0 -> (f64) {
          ...
          %prod_1 = mulf %-1by3, %u_iplus1 : f64
          %prod_-2 = mulf %-1by6, %u_iminus2 : f64
          %sum_1-2 = addf %prod_1, %prod_-2 : f64
          %sum_full = addf %sum_0-1, %sum_1-2 : f64
          %ipos_res = mulf %sum_full, %uavg : f64
          loop.yield %ipos_res : f64
      } else {
          %u_iplus2 = stencil.access %arg7[2, 0, 0] : (!stencil.view<ijk,f64>) -> f64
          %prod_-1 = mulf %-1by3, %u_iminus1 : f64
      ...
      %vavg = stencil.access %arg9[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_jminus1 = stencil.access %arg7[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_jplus1 = stencil.access %arg7[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
      %vavg_g0 = cmpf "ogt", %vavg, %zero : f64
      %jdir_res = loop.if %vavg_g0 -> (f64) {
          %u_jminus2 = stencil.access %arg7[0, -2, 0] : (!stencil.view<ijk,f64>) -> f64
          %sum_01 = addf %prod_0, %u_jminus1 : f64
          %prod_1 = mulf %-1by3, %u_jplus1 : f64
          %prod_-2 = mulf %-1by6, %u_jminus2 : f64
          %sum_1-2 = addf %prod_1, %prod_-2 : f64
          %sum_full = addf %sum_01, %sum_1-2 : f64
          %jpos_res = mulf %sum_full, %vavg : f64
          loop.yield %jpos_res : f64
      } else {
          %u_jplus2 = stencil.access %arg7[0, 2, 0] : (!stencil.view<ijk,f64>) -> f64
          %prod_-1 = mulf %-1by3, %u_jminus1 : f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, f64, f64 {
      ...
      %vavg = stencil.access %arg24[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_jminus1 = stencil.access %arg22[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_jplus1 = stencil.access %arg22[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
      %vavg_g0 = cmpf "ogt", %vavg, %zero : f64
      %jdir_res = loop.if %vavg_g0 -> (f64) {
          %u_jminus2 = stencil.access %arg22[0, -2, 0] : (!stencil.view<ijk,f64>) -> f64
          %sum_01 = addf %prod_0, %u_jminus1 : f64
          %prod_1 = mulf %-1by3, %u_jplus1 : f64
          %prod_-2 = mulf %-1by6, %u_jminus2 : f64
          %sum_1-2 = addf %prod_1, %prod_-2 : f64
          ...
          %u_jplus2 = stencil.access %arg22[0, 2, 0] : (!stencil.view<ijk,f64>) -> f64
          %prod_-1 = mulf %-1by3, %u_jminus1 : f64
          %sum_01 = addf %prod_0, %u_jplus1 : f64
          %prod_2 = mulf %-1by6, %u_jplus2 : f64
          %sum_-12 = addf %prod_-1, %prod_2 : f64

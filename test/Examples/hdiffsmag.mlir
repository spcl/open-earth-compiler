func @hdiffsmag(
  ...
  %crlavo = stencil.load %crlavo_fd : (!stencil.field<j,f64>) -> !stencil.view<j,f64>
  %crlavu = stencil.load %crlavu_fd : (!stencil.field<j,f64>) -> !stencil.view<j,f64>
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<j,f64>, f64, f64, f64 {
      ...
      %u_iminus1 = stencil.access %arg1[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_center = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<j,f64>, f64, f64, f64 {
      ...
      %u_jplus1 = stencil.access %arg1[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_center = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, f64, f64 {
      %hdmaskvel = stencil.access %arg5[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %hdweight = mulf %arg6, %hdmaskvel : f64

      %half = constant 0.5 : f64
      %zero = constant 0.0 : f64

      %T_iplus1 = stencil.access %arg2[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %T_center = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %T_10 = addf %T_iplus1, %T_center : f64
      %T_avg = mulf %T_10, %half : f64

      %S_jminus1 = stencil.access %arg3[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %S_center = stencil.access %arg3[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      ...
      %lap = stencil.access %arg4[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %u_in = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
  ...
  !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, f64, f64 {
      ...
      %T_jplus1 = stencil.access %arg2[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
      %T_center = stencil.access %arg2[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %T_10 = addf %T_jplus1, %T_center : f64
      %T_avg = mulf %T_10, %half : f64

      %S_iminus1 = stencil.access %arg3[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %S_center = stencil.access %arg3[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      ...
      %lap = stencil.access %arg4[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %v_in = stencil.access %arg1[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
	...
	stencil.store %u_out to %uout_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
	stencil.store %v_out to %vout_fd ([0, 0, 0]:[64, 64, 64]) : !stencil.view<ijk,f64> to !stencil.field<ijk,f64>
  return
}

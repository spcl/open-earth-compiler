...
func @fastwavesuv(
  ...
  %fx = stencil.load %fx_fd : (!stencil.field<j,f64>) -> !stencil.temp<j,f64>
  // ppgk
  ...
  %uout = stencil.apply %arg10 = %uin, %arg11 = %utens, %arg12 = %ppgu, %arg13 = %rho, %arg14 = %fx, %arg15 = %dt :
    !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<j,f64>, f64 {
      ...
      %3 = stencil.access %arg14[0, 0, 0] : (!stencil.temp<j,f64>) -> f64
      %4 = addf %1, %2 : f64
      %5 = mulf %cst, %3 : f64
      %6 = divf %5, %4 : f64
      %7 = mulf %0, %6 : f64
      // utens
      %8 = stencil.access %arg11[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %9 = subf %8, %7 : f64
      %10 = mulf %arg15, %9 : f64
      // uin
      %11 = stencil.access %arg10[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %12 = addf %10, %11 : f64
      stencil.return %12 : f64
  } : !stencil.temp<ijk,f64>
  // vout
  %vout = stencil.apply %arg16 = %vin, %arg17 = %vtens, %arg18 = %ppgv, %arg19 = %rho, %arg20 = %dt, %arg21 = %edadlat :
    !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, f64, f64 {
      %cst = constant 2.0 : f64
      // ppguv divided by rho
      %0 = stencil.access %arg18[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %1 = stencil.access %arg19[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      %2 = stencil.access %arg19[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %3 = addf %1, %2 : f64
      %4 = mulf %cst, %arg21 : f64
      %5 = divf %4, %3 : f64
      %6 = mulf %0, %5 : f64
      // utens
      %7 = stencil.access %arg17[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %8 = subf %7, %6 : f64
      %9 = mulf %arg20, %8 : f64
      // uin
      %10 = stencil.access %arg16[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %11 = addf %9, %10 : f64

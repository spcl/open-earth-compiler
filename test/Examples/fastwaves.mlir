...
func @fastwaves(
  ...
  %dzdx = stencil.load %dzdx_fd : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  %dzdy = stencil.load %dzdy_fd : (!stencil.field<ijk,f64>) -> !stencil.view<ijk,f64>
  // ppgk
  ...
  %udc = stencil.apply %arg18 = %wgtfac, %arg19 = %uout : 
    !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {  
      ...
      %1 = stencil.access %arg18[1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %2 = addf %0, %1 : f64
      %3 = mulf %cst0, %2 : f64
      // weighted sum
      %4 = stencil.access %arg19[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %5 = stencil.access %arg19[0, 0, -1] : (!stencil.view<ijk,f64>) -> f64   
      %6 = mulf %3, %4 : f64
      %7 = subf %cst1, %3 : f64
      %8 = mulf %7, %5 : f64
      %9 = addf %6, %8 : f64
  ...
  %vdc = stencil.apply %arg20 = %wgtfac, %arg21 = %vout : 
    !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {  
      ...
      %1 = stencil.access %arg20[0, 1, 0] : (!stencil.view<ijk,f64>) -> f64
      %2 = addf %0, %1 : f64
      %3 = mulf %cst0, %2 : f64
      // weighted sum
      %4 = stencil.access %arg21[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %5 = stencil.access %arg21[0, 0, -1] : (!stencil.view<ijk,f64>) -> f64   
      %6 = mulf %3, %4 : f64
      %7 = subf %cst1, %3 : f64
      %8 = mulf %7, %5 : f64
      %9 = addf %6, %8 : f64
  ...
  %div = stencil.apply %arg22 = %uout, %arg23 = %udc, %arg24 = %vout, %arg25 = %vdc, %arg26 = %dzdx, %arg27 = %dzdy : 
    !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64>, !stencil.view<ijk,f64> {  
      ...
      // uout(i,j,k) term
      %0 = stencil.access %arg23[0, 0, 1] : (!stencil.view<ijk,f64>) -> f64
      %1 = stencil.access %arg23[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %2 = subf %0, %1 : f64
      %3 = stencil.access %arg26[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %4 = mulf %2, %3 : f64
      %5 = stencil.access %arg22[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %6 = addf %5, %4 : f64
      %7 = mulf %fake1, %6 : f64
      // uout(i-1,j,k) term
      %8 = stencil.access %arg23[-1, 0, 1] : (!stencil.view<ijk,f64>) -> f64
      %9 = stencil.access %arg23[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %10 = subf %8, %9 : f64
      %11 = stencil.access %arg26[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %12 = mulf %10, %11 : f64
      %13 = stencil.access %arg22[-1, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %14 = addf %13, %12 : f64
      %15 = mulf %fake2, %14 : f64
      // vout(i,j,k) term
      %16 = stencil.access %arg25[0, 0, 1] : (!stencil.view<ijk,f64>) -> f64
      %17 = stencil.access %arg25[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %18 = subf %16, %17 : f64
      %19 = stencil.access %arg27[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %20 = mulf %18, %19 : f64
      %21 = stencil.access %arg24[0, 0, 0] : (!stencil.view<ijk,f64>) -> f64
      %22 = addf %21, %20 : f64
      %23 = mulf %fake3, %22 : f64
      // vout(i,j-1,k) term
      %24 = stencil.access %arg25[0, -1, 1] : (!stencil.view<ijk,f64>) -> f64
      %25 = stencil.access %arg25[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %26 = subf %24, %25 : f64
      %27 = stencil.access %arg27[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %28 = mulf %26, %27 : f64
      %29 = stencil.access %arg24[0, -1, 0] : (!stencil.view<ijk,f64>) -> f64
      %30 = addf %29, %28 : f64

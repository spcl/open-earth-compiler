...
func @nh_p_grad(
  ...
  %rdx = stencil.load %rdx_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %rdy = stencil.load %rdy_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %gz = stencil.load %gz_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %pp = stencil.load %pp_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %pk3 = stencil.load %pk3_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  %wk1 = stencil.load %wk1_fd : (!stencil.field<ijk,f64>) -> !stencil.temp<ijk,f64>
  // wk
  %wk = stencil.apply %arg1 = %pk3 : !stencil.temp<ijk,f64> {
      %pk3_kp1 = stencil.access %arg1[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_center = stencil.access %arg1[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
  ...
  !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, f64 {

      %gz_kp1 = stencil.access %arg2[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %gz_ip1 = stencil.access %arg2[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %gz_kp1mip1 = subf %gz_kp1, %gz_ip1 : f64

      %pk3_ip1kp1 = stencil.access %arg3[1, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_center = stencil.access %arg3[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_ip1kp1mcenter = subf %pk3_ip1kp1, %pk3_center : f64

      %prod_0 = mulf %gz_kp1mip1, %pk3_ip1kp1mcenter : f64

      %gz_center = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %gz_ip1kp1 = stencil.access %arg2[1, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %gz_centermip1kp1 = subf %gz_center, %gz_ip1kp1 : f64

      %pk3_kp1 = stencil.access %arg3[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_ip1 = stencil.access %arg3[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %wk_center = stencil.access %arg1[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %wk_ip1 = stencil.access %arg1[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
  ...
  !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, f64 {
      ...
      %gz_kp1 = stencil.access %arg2[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %gz_jp1 = stencil.access %arg2[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      %gz_kp1mjp1 = subf %gz_kp1, %gz_jp1 : f64

      %pk3_jp1kp1 = stencil.access %arg3[0, 1, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_center = stencil.access %arg3[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %gz_center = stencil.access %arg2[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %gz_jp1kp1 = stencil.access %arg2[0, 1, 1] : (!stencil.temp<ijk,f64>) -> f64
      %gz_centermjp1kp1 = subf %gz_center, %gz_jp1kp1 : f64

      %pk3_kp1 = stencil.access %arg3[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pk3_jp1 = stencil.access %arg3[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %wk_center = stencil.access %arg1[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %wk_jp1 = stencil.access %arg1[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
  ...
  !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, f64 {

      %gz_kp1 = stencil.access %arg2[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %gz_ip1 = stencil.access %arg2[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %gz_kp1mip1 = subf %gz_kp1, %gz_ip1 : f64

      %pp_ip1kp1 = stencil.access %arg3[1, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pp_center = stencil.access %arg3[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %pp_kp1 = stencil.access %arg3[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pp_ip1 = stencil.access %arg3[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %wk1_center = stencil.access %arg1[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %wk1_ip1 = stencil.access %arg1[1, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %uin_center = stencil.access %arg0[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %du_center = stencil.access %arg4[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64

      %u_sum = addf %uin_center, %du_center : f64

      %full_sum = addf %wk1dtsum, %u_sum : f64

      %rdx_center = stencil.access %arg5[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
  ...
  !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, !stencil.temp<ijk,f64>, f64 {
      ...
      %pp_jp1kp1 = stencil.access %arg3[0, 1, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pp_center = stencil.access %arg3[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %pp_kp1 = stencil.access %arg3[0, 0, 1] : (!stencil.temp<ijk,f64>) -> f64
      %pp_jp1 = stencil.access %arg3[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %wk1_center = stencil.access %arg1[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %wk1_jp1 = stencil.access %arg1[0, 1, 0] : (!stencil.temp<ijk,f64>) -> f64
      ...
      %vin_center = stencil.access %arg0[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
      %dv_center = stencil.access %arg4[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64

      %v_sum = addf %vin_center, %dv_center : f64

      %full_sum = addf %wk1dtsum, %v_sum : f64

      %rdy_center = stencil.access %arg5[0, 0, 0] : (!stencil.temp<ijk,f64>) -> f64
